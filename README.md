...
**User guide:** [`user-guide.md`](user-guide.md) — install steps, a tour of every tab, and how calendar export/backup work (a styled version is also at [`user-guide.html`](user-guide.html), though GitHub shows HTML as source rather than rendering it)
